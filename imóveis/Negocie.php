...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-4 me-4 mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Financie.html">Financie</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="Negocie.php">Negocie seu imóvel</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="d-flex ms-4 w-50" role="search">
                        <input class="form-control me-2" type="search" placeholder="Procure um imóvel" aria-label="Search" />
    ...
    <main class="contPrin container mt-4">

        <h3>Cadastrar Imóvel</h3>

        <form name="imovel" action="Negocie.php" method="post" enctype="multipart/form-data">

            <b>Endereço:</b>
            <input type="text" name="endereco" maxlength="50" class="form-control mb-3" required><br>

            <b>Descrição:</b>
            <textarea name="descricao" rows="3" maxlength="200" class="form-control mb-3" style="resize: none;"></textarea><br>
            ...
            <img src="img/sem_usuário.png" id="preview" class="img-fluid img-thumbnail shadow mb-3" style="width: 280px; object-fit: contain;"><br>
